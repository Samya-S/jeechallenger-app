          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 px-8 py-12 max-w-2xl mx-auto">
            <div className="flex flex-col items-center space-y-6">
              ...
              <button 
                ...
                className="bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-600 hover:to-orange-700 text-white font-medium py-3 px-6 rounded-lg transition-all duration-200 transform hover:scale-105 shadow-md hover:shadow-lg"
              >
  ...
  return (
    <div>
      ...
      <ScrollToTopButton 
        ...
        hoverColors="hover:from-amber-600 hover:to-orange-700"
      />
    </div>
  );
}

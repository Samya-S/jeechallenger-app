...
const JeeMain2022papers = () => {
  return (
    <div>
      ...
      <p className="heading text-3xl mb-4">JEE Main 2022</p>

      <section className="content-section">
        <p className="subheading text-2xl">JEE Main 2022 Session-2 Paper with Answer Key (July Attempt)</p>
      ...
      <section className="content-section">
        <p className="subheading text-2xl">JEE Main 2022 Session-2 Paper with Solutions (July Attempt)</p>
        <div className="table-outer">
          <table cellSpacing="0" cellPadding="0" align="center">
            <tbody>
              <tr>
      ...
      <section className="content-section">
        <p className="subheading text-2xl">JEE Main 2022 Session-1 Paper with Answer Key (June Attempt)</p>
        <div className="table-outer">
          <table cellSpacing="0" cellPadding="0" align="center">
            <tbody>
              <tr>
      ...
      <section className="content-section">
        <p className="subheading text-2xl">JEE Main 2022 Session-1 Paper with Solutions (June Attempt)</p>
        <div className="table-outer">
          <table cellSpacing="0" cellPadding="0" align="center">
            <tbody>
              <tr>

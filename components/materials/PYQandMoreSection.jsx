            ...
            <div className="p-6 text-center flex flex-col h-full">
              ...
              <div className="mt-auto">
                <Link href="/ai-tutor" aria-label="Start learning with AI Tutor">
                  <button className="bg-gradient-to-r from-violet-500 to-purple-600 hover:from-violet-600 hover:to-purple-700 text-white font-medium py-3 px-6 rounded-lg transition-all duration-200 transform hover:scale-105 shadow-md hover:shadow-lg">
                    Try AI Tutor Now
                  </button>
                </Link>
              </div>
